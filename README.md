...
* 💻 **Passionate Programmer**: I love working with web development, from building solid back-end architectures to creating engaging front-end interfaces.
...
* 💻 **Programador Apaixonado**: Adoro trabalhar com desenvolvimento web, tanto criando a lógica no back-end quanto construindo a interface no front-end.
* 🎓 **Estudante de TI**: Atualmente faço faculdade na área de tecnologia.
* 💼 **Atuação Profissional**: Já atuo profissionalmente no setor de TI, aplicando meus conhecimentos na prática diariamente.
* 🚀 **Foco**: Criar sistemas eficientes, bancos de dados estruturados e aprender novas tecnologias.
